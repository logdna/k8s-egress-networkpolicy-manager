...
from ipcollector.ipaddr import GetIp, valid_ip, collect_ip
...
logging.basicConfig(format='%(asctime)s %(levelname)-8s %(message)s', level=App.config("LOGLEVEL"), datefmt='%Y-%m-%d %H:%M:%S')
